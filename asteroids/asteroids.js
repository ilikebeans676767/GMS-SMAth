...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5310320,
    DYNAMIC_BASE = 5310320,
    DYNAMICTOP_PTR = 67184;
...
var wasmBinaryFile = 'asteroids.wasm';
...
// {{PRE_LIBRARY}}
  ...
  var _stderr=67232;var FS={root:null,mounts:[],devices:{},streams:[],nextInode:1,nameTable:null,currentPath:"/",initialized:false,ignorePermissions:true,trackingDelegate:{},tracking:{openFlags:{READ:1,WRITE:2}},ErrnoError:null,genericErrors:{},filesystems:null,syncFSRequests:0,handleFSError:function (e) {
  ...
  var GL={counter:1,lastError:0,buffers:[],mappedBuffers:{},programs:[],framebuffers:[],renderbuffers:[],textures:[],uniforms:[],shaders:[],vaos:[],contexts:{},currentContext:null,offscreenCanvases:{},timerQueriesEXT:[],programInfos:{},stringCache:{},unpackAlignment:4,init:function () {
        ...
        for (var i = 0; i < count; ++i) {
          ...
          source += UTF8ToString(HEAP32[(((string)+(i*4))>>2)], len >= 0 ? len : undefined);
        }
        return source;
